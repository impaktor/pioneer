...
-- local ui = import 'pigui/themes/default.lua'
...
local makeAdvert = function (station)
	...
	local ref = station:AddAdvert({
		description = ad.desc,
		icon        = ad.urgency >=  0.8 and ui.theme.icons.haul_urgent or ui.theme.icons.haul,
		onChat      = onChat,
		onDelete    = onDelete,
		isEnabled   = isEnabled })
	ads[ref] = ad
	...
	if loaded_data and loaded_data.ads then
		...
		for k,ad in pairs(loaded_data.ads) do
			local ref = ad.station:AddAdvert({
				description = ad.desc,
				icon        = ad.urgency >=  0.8 and ui.theme.icons.haul_fast or ui.theme.icons.haul,
				onChat      = onChat,
				onDelete    = onDelete,
				isEnabled   = isEnabled })
			ads[ref] = ad
